...
export default function Fileapi(){
    ...
    return(
        ...
        dat.map((index,value)=>(
            ...
            <p className="card-text"><span style={{color:"red"}}>Price:</span>{index.price}</p>
            <p className="card-text"><span style={{color:"red"}}>Category:</span>{index.category}</p>
            <p className="card-text"><span style={{color:"red"}}>Rating:</span>
            <StarRatings
            rating={index.rating.rate}
            starDimension="20px"
            starSpacing="4px"/>
            {index.rating.rate}</p>
            <p className="card-text"><span style={{color:"green"}}>InStock:</span>{index.rating.count}</p>
